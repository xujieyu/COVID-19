const PINYIN = ['hubei', 'guangdong', 'zhejiang', 'chongqing', 'hunan', 'anhui', 'beijing', 'shanghai', 'henan', 'sichuan', 'shandong', 'guangxi', 'jiangxi', 'fujian', 'jiangsu', 'hainan', 'liaoning', 'shanxi', 'yunnan', 'tianjin', 'heilongjiang', 'hebei', 'shanxi', 'xianggang', 'guizhou', 'jilin', 'gansu', 'ningxia', 'taiwan', 'xinjiang', 'aomen', 'neimenggu', 'qinghai', 'xizang']
